...
typedef char Itemp; // Tipo de dado do vetor da pilha.

/* Estrutura da pilha */

typedef struct pilha {
    int max;                // Número de elementos do vetor da pilha.
    int topo;               // Posicão do topo no vetor da pilha.
    Itemp *item;            // Elementos do vetor da pilha
} *Pilha;
